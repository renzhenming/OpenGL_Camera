#ifndef rzm_opengl_camera_manager_message_queue_Message
#define rzm_opengl_camera_manager_message_queue_Message

#include <pthread.h>


#define MESSAGE_QUEUE_LOOP_QUIT_FLAG        19910502
...
#endif // rzm_opengl_camera_manager_message_queue_Message
